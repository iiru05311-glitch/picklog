          ...
          <Pressable onPress={() => {}}>
            ...
            <View style={styles.head}>
              ...
              <Pressable onPress={handleSave} disabled={!url}>
                <Text style={[styles.saveBtn, !url && styles.saveBtnDisabled]}>저장</Text>
              </Pressable>
            </View>
              ...
              <Field label="폴더">
                <View style={styles.folderRow}>
                  {FOLDERS.map(f => (
                    <Pressable
                      key={f.name}
                      style={[styles.folderPick, folder === f.name && styles.folderPickOn]}
                      onPress={() => setFolder(f.name)}
                    >
                      <View style={[styles.catDot, { backgroundColor: catColor(f.cat) }]} />
                      <Text style={[styles.folderPickText, folder === f.name && styles.folderPickTextOn]}>
                        {f.name}
                      </Text>
                    </Pressable>
                  ))}
